//! The master-output-enable (MOE) arming gate (`specs/sensing-and-safety.md`; the stock
//! contract is the recovered state.md §4/§8). Recovered from the archived implementation
