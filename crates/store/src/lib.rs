...
pub use field::{
    lookup, registry, BlobField, Field, FieldDef, StrField, BOARD_BUZZER, BOARD_SELF_HOLD,
    BOARD_VBATT, CONTROL_MODE, DEVICE_NAME, IMU_MODEL, IMU_SCL_PIN, IMU_SDA_PIN, LED_GREEN,
    LED_ORANGE, LED_RED, LINK_SET, MOTOR_CURRENT_LIMIT, MOTOR_DEAD_TIME, MOTOR_GATE_HI_A,
    MOTOR_GATE_HI_B, MOTOR_GATE_HI_C, MOTOR_GATE_LO_A, MOTOR_GATE_LO_B, MOTOR_GATE_LO_C,
    MOTOR_HALL_A, MOTOR_HALL_B, MOTOR_HALL_C, MOTOR_METHOD, NODE_ADDRESS, PAD_A, PAD_B, PIN_ABSENT,
    REGISTRY_LEN, SOME_BLOB,
};
