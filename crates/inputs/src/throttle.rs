...
//! ([`Fix`] = I32F32, 32 fractional bits, `base::fixed` being the workspace's Q owner) with the
//! coefficients reproduced exactly. The very slow tau
