 ...
 *
 * Synchronous and I/O-free by design: the round-trip runner drives it (drain the outgoing bytes to the
 * write char; feed notification bytes to [onReceive]) over the live BLE coroutine plumbing.
 */
