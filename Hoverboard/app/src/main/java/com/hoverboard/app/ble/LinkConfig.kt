 ...
 *
 * Default for the bench: the master module advertises **"Pal"** (the AT+NAME the firmware sets). If
 * the module is in a stale data-mode name, scan for whatever it actually advertises by overriding
 * [deviceName].
 */
data class LinkConfig(
    ...
    companion object {
        /** Advertised name the current bench module reports. */
        const val DEFAULT_DEVICE_NAME: String = "Pal"
    }
}
