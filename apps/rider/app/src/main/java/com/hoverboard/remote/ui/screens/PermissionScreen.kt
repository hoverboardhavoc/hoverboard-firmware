...
/**
 * Permission rationale screen (house stack §Permissions). Explains why Bluetooth is needed
 * before triggering the system dialog for BLUETOOTH_SCAN + BLUETOOTH_CONNECT (Android 12+).
 *
